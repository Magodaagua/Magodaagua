...
<div class="container text-light">
		...
		<div class="row justify-content-center mt-3 my-3 mx-3" align="center">
			...
			<p class="display-4"> Dado Único </p>

		</div>

		<div class="row justify-content-center mx-3">

			<form method="POST" action="dadosmultiplos.php">

				<button type="submit" class="btn btn-light mx-3">Dados múltiplos</button>
		...
		<div class="row justify-content-center mt-2 mb-1 mx-3">
			...
			<div class="col-6 col-md-2">
				...
				<select class="form-control mb-2" id="lados" type='number' name='nLados' onchange="mudarDado()">
		...
		<div class="row justify-content-center my-1">
			<img src="_media/d4/image/1d4.png" class="img" onclick="slideit()" id="slide" width="300px" height="300px" />
